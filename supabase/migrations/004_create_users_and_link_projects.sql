...
-- 6. 测试数据（学号格式：YYYYMMDD-NN，确保唯一）
INSERT INTO public.users (student_code, name, institution, activity_date, session_number) VALUES
  ('20260530-01', '张三', '武宁路实验小学', '2026-05-30', 1),
  ('20260530-02', '李四', '武宁路实验小学', '2026-05-30', 1),
  ('20260530-03', '王五', '武宁路实验小学', '2026-05-30', 1),
  ('20260530-04', '赵六', '武宁路实验小学', '2026-05-30', 1),
  ('20260530-05', '钱七', '武宁路实验小学', '2026-05-30', 1),
  ('20260530-06', '孙八', '武宁路实验小学', '2026-05-30', 2),
  ('20260530-07', '周九', '武宁路实验小学', '2026-05-30', 2),
  ('20260530-08', '吴十', '武宁路实验小学', '2026-05-30', 2),
  ('20260603-01', '妮妮', '武宁路实验小学', '2026-06-03', 1),
  ('20260603-02', '小明', '武宁路实验小学', '2026-06-03', 1)
